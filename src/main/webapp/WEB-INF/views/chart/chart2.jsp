...
<html>
	<head>
		<meta charset="UTF-8">
		<title>일반게시판 - 댓글수ㆍ조회수</title>
		<link rel="stylesheet" href="../css/chart/chart2.css">
		<script src="http://code.jquery.com/jquery-latest.min.js"></script>
		<script src="https://cdn.jsdelivr.net/npm/chart.js"></script>
		<script type="text/javascript">
		
			//Multi Axis Chartjs
			//참고1 : https://velog.io/@odobenus/chartjs-multi-axis-bar-chart
			//참고2 : http://john-home.iptime.org:8085/xe/index.php?mid=board_fPsP79&document_srl=1877
			...
			$(document).ready(function(){
				...
				chartMultiAxis($("#selected").val());   //챠트 그리기
		...
		<c:choose>
			<c:when test="${session_flag eq 'success'}">
				...
				<div id="board_outline">
					<div id="title_area">
						<h2><font color="red">일반</font> 게시판 - 댓글수ㆍ조회수</h2> 
					</div>
