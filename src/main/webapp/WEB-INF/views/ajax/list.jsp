		...
		<!-- <link rel="stylesheet" href="../css/board/style.css">
  		...
  		<script type="text/javascript">
  			...
  			function ajaxWrite(page){
	  			...
	  			window.open("./write?page="+page, "_blank", "status=no, width=800, height=550, left="+popupX+", top="+popupY+", screenX="+popupX+", screenY="+popupY);
  			}//ajaxWrite()
  			...
  			function showView(postNum_ajax, page){
	  			...
	  			window.open("./view?postNum_ajax="+postNum_ajax+"&page="+page, "_blank", "status=no, width=800, height=550, left="+popupX+", top="+popupY+", screenX="+popupX+", screenY="+popupY);
  			}//showDetails()
